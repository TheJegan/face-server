...
var TaskAgentApiBase = (function (_super) {
     ...
     * @param onResult callback function with the resulting TaskAgentInterfaces.TaskAgentJobRequest[]
     */
    TaskAgentApiBase.prototype.getAgentRequestsForAgent = function (poolId, agentId, completedRequestCount, onResult) {
        var _this = this;
        var routeValues = {
            poolId: poolId
        };
     ...
     * @param onResult callback function with the resulting TaskAgentInterfaces.TaskAgentJobRequest[]
     */
    TaskAgentApiBase.prototype.getAgentRequestsForAgents = function (poolId, agentIds, completedRequestCount, onResult) {
        var _this = this;
        var routeValues = {
            poolId: poolId
        };
     ...
     * @param onResult callback function with the resulting TaskAgentInterfaces.TaskAgentJobRequest[]
     */
    TaskAgentApiBase.prototype.getAgentRequestsForPlan = function (poolId, planId, jobId, onResult) {
        var _this = this;
        var routeValues = {
            poolId: poolId
        };
    ...
    TaskAgentApiBase.prototype.getPackage = function (packageType, onResult) {
        ...
        this.vsoClient.getVersioningData("3.0-preview.1", "distributedtask", "8ffcd551-079c-493a-9c02-54346299d144", routeValues)
            .then(function (versioningData) {
            var url = versioningData.requestUrl;
            var apiVersion = versioningData.apiVersion;
     ...
     */
    TaskAgentApiBase.prototype.createServiceEndpoint = function (endpoint, scopeIdentifier, onResult) {
        var _this = this;
        var routeValues = {
            scopeIdentifier: scopeIdentifier
        };
     ...
     * @param onResult callback function with the resulting TaskAgentInterfaces.ServiceEndpoint
     */
    TaskAgentApiBase.prototype.updateServiceEndpoint = function (endpoint, scopeIdentifier, endpointId, onResult) {
        var _this = this;
        var routeValues = {
            scopeIdentifier: scopeIdentifier,
            endpointId: endpointId
...
var QTaskAgentApiBase = (function (_super) {
    ...
    * @param {number} completedRequestCount
    */
    QTaskAgentApiBase.prototype.getAgentRequestsForAgent = function (poolId, agentId, completedRequestCount) {
        var deferred = Q.defer();
        this.api.getAgentRequestsForAgent(poolId, agentId, completedRequestCount, function (err, statusCode, jobrequests) {
            if (err) {
                err.statusCode = statusCode;
                deferred.reject(err);
            }
    ...
    * @param {number} completedRequestCount
    */
    QTaskAgentApiBase.prototype.getAgentRequestsForAgents = function (poolId, agentIds, completedRequestCount) {
        var deferred = Q.defer();
        this.api.getAgentRequestsForAgents(poolId, agentIds, completedRequestCount, function (err, statusCode, jobrequests) {
            if (err) {
                err.statusCode = statusCode;
                deferred.reject(err);
            }
    ...
    * @param {string} jobId
    */
    QTaskAgentApiBase.prototype.getAgentRequestsForPlan = function (poolId, planId, jobId) {
        var deferred = Q.defer();
        this.api.getAgentRequestsForPlan(poolId, planId, jobId, function (err, statusCode, jobrequests) {
            if (err) {
                err.statusCode = statusCode;
                deferred.reject(err);
            }
    ...
    * @param {string} scopeIdentifier - The project GUID to scope the request
    */
    QTaskAgentApiBase.prototype.createServiceEndpoint = function (endpoint, scopeIdentifier) {
        var deferred = Q.defer();
        this.api.createServiceEndpoint(endpoint, scopeIdentifier, function (err, statusCode, serviceendpoint) {
            if (err) {
                err.statusCode = statusCode;
                deferred.reject(err);
            }
    ...
    * @param {string} endpointId
    */
    QTaskAgentApiBase.prototype.updateServiceEndpoint = function (endpoint, scopeIdentifier, endpointId) {
        var deferred = Q.defer();
        this.api.updateServiceEndpoint(endpoint, scopeIdentifier, endpointId, function (err, statusCode, serviceendpoint) {
            if (err) {
                err.statusCode = statusCode;
                deferred.reject(err);
            }
