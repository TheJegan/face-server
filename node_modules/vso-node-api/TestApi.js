...
var TestApi = (function (_super) {
     ...
     */
    TestApi.prototype.getBugsLinkedToTestResult = function (project, runId, testCaseResultId, onResult) {
        var _this = this;
        var routeValues = {
            project: project,
            runId: runId,
     ...
     */
    TestApi.prototype.createTestConfiguration = function (testConfiguration, project, onResult) {
        var _this = this;
        var routeValues = {
            project: project
        };
     ...
     * @param onResult callback function
     */
    TestApi.prototype.deleteTestConfiguration = function (project, testConfigurationId, onResult) {
        var _this = this;
        var routeValues = {
            project: project,
     ...
     * @param onResult callback function with the resulting TestInterfaces.TestConfiguration
     */
    TestApi.prototype.getTestConfigurationById = function (project, testConfigurationId, onResult) {
        var _this = this;
        var routeValues = {
            project: project,
            testConfigurationId: testConfigurationId
     ...
     * @param onResult callback function with the resulting TestInterfaces.TestConfiguration[]
     */
    TestApi.prototype.getTestConfigurations = function (project, skip, top, includeAllProperties, onResult) {
        var _this = this;
        var routeValues = {
            project: project
        };
     ...
     * @param onResult callback function with the resulting TestInterfaces.TestConfiguration
     */
    TestApi.prototype.updateTestConfiguration = function (testConfiguration, project, testConfigurationId, onResult) {
        var _this = this;
        var routeValues = {
            project: project,
            testConfigurationId: testConfigurationId
     ...
     */
    TestApi.prototype.getPlanCloneInformation = function (project, operationId, includeDetails, onResult) {
        var _this = this;
        var routeValues = {
            project: project
        };
     ...
     * @param onResult callback function
     */
    TestApi.prototype.deleteTestPlan = function (project, planId, onResult) {
        var _this = this;
        var routeValues = {
            project: project,
            planId: planId
     ...
     * @param onResult callback function with the resulting TestInterfaces.CloneOperationInformation
     */
    TestApi.prototype.cloneTestPlan = function (cloneRequestBody, project, sourcePlanId, onResult) {
        var _this = this;
        var routeValues = {
            project: project,
     ...
     */
    TestApi.prototype.getTestResultDetailsForBuild = function (project, buildId, publishContext, groupBy, filter, onResult) {
        var _this = this;
        var routeValues = {
            project: project
        };
     ...
     * @param onResult callback function with the resulting TestInterfaces.TestResultsDetails
     */
    TestApi.prototype.getTestResultDetailsForRelease = function (project, releaseId, releaseEnvId, publishContext, groupBy, filter, onResult) {
        var _this = this;
        var routeValues = {
            project: project
        };
     ...
     * @param onResult callback function with the resulting TestInterfaces.TestCaseResult
     */
    TestApi.prototype.getTestCaseResultById = function (project, runId, testCaseResultId, includeIterationDetails, includeAssociatedBugs, onResult) {
        var _this = this;
        var routeValues = {
            project: project,
            runId: runId,
     ...
     * @param onResult callback function with the resulting TestInterfaces.TestCaseResult[]
     */
    TestApi.prototype.getTestResultsByIds = function (ids, project, fields, onResult) {
        var _this = this;
        var routeValues = {
            project: project
        };
        ...
        this.vsoClient.getVersioningData("3.0-preview.2", "Test", "6711da49-8e6f-4d35-9f73-cef7a3c81a5b", routeValues, queryValues)
            ...
            _this.restClient.create(url, apiVersion, ids, null, serializationData, onResult);
        })
            .fail(function (error) {
            onResult(error, error.statusCode, null);
        });
     ...
     */
    TestApi.prototype.queryTestResultsReportForBuild = function (project, buildId, publishContext, includeFailureDetails, buildToCompare, onResult) {
        var _this = this;
        var routeValues = {
            project: project
        };
     ...
     * @param onResult callback function with the resulting TestInterfaces.TestResultSummary
     */
    TestApi.prototype.queryTestResultsReportForRelease = function (project, releaseId, releaseEnvId, publishContext, includeFailureDetails, releaseToCompare, onResult) {
        var _this = this;
        var routeValues = {
            project: project
        };
     ...
     */
    TestApi.prototype.queryResultTrendForBuild = function (filter, project, onResult) {
        var _this = this;
        var routeValues = {
            project: project
        };
     ...
     * @param onResult callback function with the resulting TestInterfaces.CloneOperationInformation
     */
    TestApi.prototype.getSuiteCloneInformation = function (project, operationId, includeDetails, onResult) {
        var _this = this;
        var routeValues = {
            project: project
        };
     ...
     * @param onResult callback function with the resulting TestInterfaces.TestSuite[]
     */
    TestApi.prototype.getTestSuitesForPlan = function (project, planId, includeSuites, skip, top, asTreeView, onResult) {
        var _this = this;
        var routeValues = {
            project: project,
            planId: planId
     ...
     * @param onResult callback function with the resulting TestInterfaces.CloneOperationInformation
     */
    TestApi.prototype.cloneTestSuite = function (cloneRequestBody, project, sourceSuiteId, planId, onResult) {
        var _this = this;
        var routeValues = {
            project: project,
     ...
     */
    TestApi.prototype.createTestVariable = function (testVariable, project, onResult) {
        var _this = this;
        var routeValues = {
            project: project
        };
     ...
     * @param onResult callback function
     */
    TestApi.prototype.deleteTestVariable = function (project, testVariableId, onResult) {
        var _this = this;
        var routeValues = {
            project: project,
     ...
     * @param onResult callback function with the resulting TestInterfaces.TestVariable
     */
    TestApi.prototype.getTestVariable = function (project, testVariableId, onResult) {
        var _this = this;
        var routeValues = {
            project: project,
            testVariableId: testVariableId
     ...
     * @param onResult callback function with the resulting TestInterfaces.TestVariable[]
     */
    TestApi.prototype.getTestVariables = function (project, skip, top, onResult) {
        var _this = this;
        var routeValues = {
            project: project
        };
     ...
     * @param onResult callback function with the resulting TestInterfaces.TestVariable
     */
    TestApi.prototype.updateTestVariable = function (testVariable, project, testVariableId, onResult) {
        var _this = this;
        var routeValues = {
            project: project,
            testVariableId: testVariableId
...
var QTestApi = (function (_super) {
    ...
    * @param {number} testCaseResultId
    */
    QTestApi.prototype.getBugsLinkedToTestResult = function (project, runId, testCaseResultId) {
        var deferred = Q.defer();
        this.api.getBugsLinkedToTestResult(project, runId, testCaseResultId, function (err, statusCode, Bugs) {
            if (err) {
                err.statusCode = statusCode;
                deferred.reject(err);
            }
    ...
    * @param {string} project - Project ID or project name
    */
    QTestApi.prototype.createTestConfiguration = function (testConfiguration, project) {
        var deferred = Q.defer();
        this.api.createTestConfiguration(testConfiguration, project, function (err, statusCode, Configuration) {
            if (err) {
                err.statusCode = statusCode;
                deferred.reject(err);
            }
    ...
    * @param {number} testConfigurationId
    */
    QTestApi.prototype.deleteTestConfiguration = function (project, testConfigurationId) {
        var deferred = Q.defer();
        this.api.deleteTestConfiguration(project, testConfigurationId, function (err, statusCode) {
            if (err) {
                err.statusCode = statusCode;
                deferred.reject(err);
            }
    ...
    * @param {number} testConfigurationId
    */
    QTestApi.prototype.getTestConfigurationById = function (project, testConfigurationId) {
        var deferred = Q.defer();
        this.api.getTestConfigurationById(project, testConfigurationId, function (err, statusCode, Configuration) {
            if (err) {
                err.statusCode = statusCode;
                deferred.reject(err);
            }
    ...
    * @param {boolean} includeAllProperties
    */
    QTestApi.prototype.getTestConfigurations = function (project, skip, top, includeAllProperties) {
        var deferred = Q.defer();
        this.api.getTestConfigurations(project, skip, top, includeAllProperties, function (err, statusCode, Configurations) {
            if (err) {
                err.statusCode = statusCode;
                deferred.reject(err);
            }
    ...
    * @param {number} testConfigurationId
    */
    QTestApi.prototype.updateTestConfiguration = function (testConfiguration, project, testConfigurationId) {
        var deferred = Q.defer();
        this.api.updateTestConfiguration(testConfiguration, project, testConfigurationId, function (err, statusCode, Configuration) {
            if (err) {
                err.statusCode = statusCode;
                deferred.reject(err);
            }
    ...
    * @param {boolean} includeDetails
    */
    QTestApi.prototype.getPlanCloneInformation = function (project, operationId, includeDetails) {
        var deferred = Q.defer();
        this.api.getPlanCloneInformation(project, operationId, includeDetails, function (err, statusCode, Plan) {
            if (err) {
                err.statusCode = statusCode;
                deferred.reject(err);
            }
    ...
    * @param {number} planId
    */
    QTestApi.prototype.deleteTestPlan = function (project, planId) {
        var deferred = Q.defer();
        this.api.deleteTestPlan(project, planId, function (err, statusCode) {
            if (err) {
                err.statusCode = statusCode;
                deferred.reject(err);
            }
    ...
    * @param {number} sourcePlanId
    */
    QTestApi.prototype.cloneTestPlan = function (cloneRequestBody, project, sourcePlanId) {
        var deferred = Q.defer();
        this.api.cloneTestPlan(cloneRequestBody, project, sourcePlanId, function (err, statusCode, Plan) {
            if (err) {
                err.statusCode = statusCode;
                deferred.reject(err);
            }
    ...
    * @param {string} filter
    */
    QTestApi.prototype.getTestResultDetailsForBuild = function (project, buildId, publishContext, groupBy, filter) {
        var deferred = Q.defer();
        this.api.getTestResultDetailsForBuild(project, buildId, publishContext, groupBy, filter, function (err, statusCode, ResultDetailsByBuild) {
            if (err) {
                err.statusCode = statusCode;
                deferred.reject(err);
            }
    ...
    * @param {string} filter
    */
    QTestApi.prototype.getTestResultDetailsForRelease = function (project, releaseId, releaseEnvId, publishContext, groupBy, filter) {
        var deferred = Q.defer();
        this.api.getTestResultDetailsForRelease(project, releaseId, releaseEnvId, publishContext, groupBy, filter, function (err, statusCode, ResultDetailsByRelease) {
            if (err) {
                err.statusCode = statusCode;
                deferred.reject(err);
            }
    ...
    * @param {boolean} includeAssociatedBugs
    */
    QTestApi.prototype.getTestCaseResultById = function (project, runId, testCaseResultId, includeIterationDetails, includeAssociatedBugs) {
        var deferred = Q.defer();
        this.api.getTestCaseResultById(project, runId, testCaseResultId, includeIterationDetails, includeAssociatedBugs, function (err, statusCode, Result) {
            if (err) {
                err.statusCode = statusCode;
                deferred.reject(err);
            }
    ...
    * @param {string[]} fields
    */
    QTestApi.prototype.getTestResultsByIds = function (ids, project, fields) {
        var deferred = Q.defer();
        this.api.getTestResultsByIds(ids, project, fields, function (err, statusCode, Results) {
            if (err) {
                err.statusCode = statusCode;
                deferred.reject(err);
            }
    ...
    * @param {TestInterfaces.BuildReference} buildToCompare
    */
    QTestApi.prototype.queryTestResultsReportForBuild = function (project, buildId, publishContext, includeFailureDetails, buildToCompare) {
        var deferred = Q.defer();
        this.api.queryTestResultsReportForBuild(project, buildId, publishContext, includeFailureDetails, buildToCompare, function (err, statusCode, ResultSummaryByBuild) {
            if (err) {
                err.statusCode = statusCode;
                deferred.reject(err);
            }
    ...
    * @param {TestInterfaces.ReleaseReference} releaseToCompare
    */
    QTestApi.prototype.queryTestResultsReportForRelease = function (project, releaseId, releaseEnvId, publishContext, includeFailureDetails, releaseToCompare) {
        var deferred = Q.defer();
        this.api.queryTestResultsReportForRelease(project, releaseId, releaseEnvId, publishContext, includeFailureDetails, releaseToCompare, function (err, statusCode, ResultSummaryByRelease) {
            if (err) {
                err.statusCode = statusCode;
                deferred.reject(err);
            }
    ...
    * @param {string} project - Project ID or project name
    */
    QTestApi.prototype.queryResultTrendForBuild = function (filter, project) {
        var deferred = Q.defer();
        this.api.queryResultTrendForBuild(filter, project, function (err, statusCode, ResultTrendByBuild) {
            if (err) {
                err.statusCode = statusCode;
                deferred.reject(err);
            }
    ...
    * @param {boolean} includeDetails
    */
    QTestApi.prototype.getSuiteCloneInformation = function (project, operationId, includeDetails) {
        var deferred = Q.defer();
        this.api.getSuiteCloneInformation(project, operationId, includeDetails, function (err, statusCode, Suite) {
            if (err) {
                err.statusCode = statusCode;
                deferred.reject(err);
            }
    ...
    * @param {boolean} asTreeView
    */
    QTestApi.prototype.getTestSuitesForPlan = function (project, planId, includeSuites, skip, top, asTreeView) {
        var deferred = Q.defer();
        this.api.getTestSuitesForPlan(project, planId, includeSuites, skip, top, asTreeView, function (err, statusCode, Suites) {
            if (err) {
                err.statusCode = statusCode;
                deferred.reject(err);
            }
    ...
    * @param {number} planId
    */
    QTestApi.prototype.cloneTestSuite = function (cloneRequestBody, project, sourceSuiteId, planId) {
        var deferred = Q.defer();
        this.api.cloneTestSuite(cloneRequestBody, project, sourceSuiteId, planId, function (err, statusCode, Suite) {
            if (err) {
                err.statusCode = statusCode;
                deferred.reject(err);
            }
    ...
    * @param {string} project - Project ID or project name
    */
    QTestApi.prototype.createTestVariable = function (testVariable, project) {
        var deferred = Q.defer();
        this.api.createTestVariable(testVariable, project, function (err, statusCode, Variable) {
            if (err) {
                err.statusCode = statusCode;
                deferred.reject(err);
            }
    ...
    * @param {number} testVariableId
    */
    QTestApi.prototype.deleteTestVariable = function (project, testVariableId) {
        var deferred = Q.defer();
        this.api.deleteTestVariable(project, testVariableId, function (err, statusCode) {
            if (err) {
                err.statusCode = statusCode;
                deferred.reject(err);
            }
    ...
    * @param {number} testVariableId
    */
    QTestApi.prototype.getTestVariable = function (project, testVariableId) {
        var deferred = Q.defer();
        this.api.getTestVariable(project, testVariableId, function (err, statusCode, Variable) {
            if (err) {
                err.statusCode = statusCode;
                deferred.reject(err);
            }
    ...
    * @param {number} top
    */
    QTestApi.prototype.getTestVariables = function (project, skip, top) {
        var deferred = Q.defer();
        this.api.getTestVariables(project, skip, top, function (err, statusCode, Variables) {
            if (err) {
                err.statusCode = statusCode;
                deferred.reject(err);
            }
    ...
    * @param {number} testVariableId
    */
    QTestApi.prototype.updateTestVariable = function (testVariable, project, testVariableId) {
        var deferred = Q.defer();
        this.api.updateTestVariable(testVariable, project, testVariableId, function (err, statusCode, Variable) {
            if (err) {
                err.statusCode = statusCode;
                deferred.reject(err);
            }
