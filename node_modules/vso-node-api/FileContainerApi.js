...
var FileContainerApi = (function (_super) {
    ...
    FileContainerApi.prototype.createItem = function (contentStream, uncompressedLength, containerId, itemPath, scope, options, onResult) {
...
var QFileContainerApi = (function (_super) {
    ...
    QFileContainerApi.prototype.createItem = function (contentStream, uncompressedLength, containerId, itemPath, scope, options) {
        var deferred = Q.defer();
        this.api.createItem(contentStream, uncompressedLength, containerId, itemPath, scope, options, function (err, statusCode, item) {
            if (err) {
...
}(FileContainerApiBase.QFileContainerApiBase));
