...
var GalleryApi = (function (_super) {
     ...
     * @param onResult callback function with the resulting ArrayBuffer
     */
    GalleryApi.prototype.getPackage = function (publisherName, extensionName, version, accountToken, acceptDefault, onResult) {
        var _this = this;
        var routeValues = {
            publisherName: publisherName,
            extensionName: extensionName,
     ...
     */
    GalleryApi.prototype.createReview = function (review, extensionId, onResult) {
        var _this = this;
        var routeValues = {
            extensionId: extensionId
        };
        this.vsoClient.getVersioningData("3.0-preview.1", "gallery", "5b3f819f-f247-42ad-8c00-dd9ab9ab246d", routeValues)
            .then(function (versioningData) {
            var url = versioningData.requestUrl;
            var apiVersion = versioningData.apiVersion;
     ...
     */
    GalleryApi.prototype.getReviews = function (extensionId, onResult) {
        var _this = this;
        var routeValues = {
            extensionId: extensionId
        };
...
var QGalleryApi = (function (_super) {
    ...
    * @param {boolean} acceptDefault
    */
    QGalleryApi.prototype.getPackage = function (publisherName, extensionName, version, accountToken, acceptDefault) {
        var deferred = Q.defer();
        this.api.getPackage(publisherName, extensionName, version, accountToken, acceptDefault, function (err, statusCode, _package) {
            if (err) {
                err.statusCode = statusCode;
                deferred.reject(err);
            }
    ...
    * @param {string} extensionId
    */
    QGalleryApi.prototype.createReview = function (review, extensionId) {
        var deferred = Q.defer();
        this.api.createReview(review, extensionId, function (err, statusCode, review) {
            if (err) {
                err.statusCode = statusCode;
                deferred.reject(err);
            }
    ...
    * @param {string} extensionId - Guid of the extension whose reviews need to be retrieved
    */
    QGalleryApi.prototype.getReviews = function (extensionId) {
        var deferred = Q.defer();
        this.api.getReviews(extensionId, function (err, statusCode, review) {
            if (err) {
                err.statusCode = statusCode;
                deferred.reject(err);
            }
