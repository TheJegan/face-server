...
var VsoClient = (function () {
    ...
    */
    ...
    VsoClient.prototype.getSerializedObject = function (object) {
        var value = "";
        var first = true;
    ...
    */
    ...
    VsoClient.prototype._getLinkResponseHeaders = function (xhr) {
        var results = {}, responseHeadersString = xhr.getAllResponseHeaders(), // cannot use xhr.getResponseHeader('Link') because jquery/IE bug
        rheaders = /^(.*?):[ \t]*([^\r\n]*)\r?$/mg, // IE leaves an \r character at EOL
        linkRegExp = /\<(.*?)\>;rel=\"(.*?)\"/g, headerMatch, linkMatch;
